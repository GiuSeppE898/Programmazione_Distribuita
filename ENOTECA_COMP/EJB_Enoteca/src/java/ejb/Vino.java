...
import static ejb.Vino.RICERCA_CATEGORIA;
...
@NamedQueries({
    ...
    @NamedQuery(name=RICERCA_CATEGORIA, query="SELECT v FROM Vino v WHERE v.tipologia=:tipologia"),
...
public class Vino implements Serializable {
    ...
    public static final String RICERCA_CATEGORIA ="Vino.ricercaTipologia";
